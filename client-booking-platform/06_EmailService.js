...
function buildBookingNotificationHtml_(booking, eventType, dashboardUrl, integration) {
  ...
  return [
    '<div style="font-family:Arial,sans-serif;color:#221874;max-width:620px">',
    '<div style="background:#3d21bf;color:#fff;padding:24px 28px;border-radius:14px 14px 0 0">',
    '<div style="font-size:12px;font-weight:bold;letter-spacing:1.4px;text-transform:uppercase">FIKA hospitality</div>',
    '<h1 style="font-size:26px;margin:8px 0 0">New Angel Court booking</h1>',
    '</div>',
    '<div style="padding:26px 28px;border:1px solid #dedbea;border-top:0;border-radius:0 0 14px 14px">',
    '<p style="margin-top:0;color:#5f5a82">A new client booking request is ready for review.</p>',
    '<table style="width:100%;border-collapse:collapse">',
    rows.map(function(row) {
      return '<tr>' +
        '<td style="padding:9px 8px;border-bottom:1px solid #eeeaf4;color:#716c8e">' +
    ...
    dashboardUrl
      ? '<p style="margin:24px 0 8px"><a href="' +
        ...
        '" style="display:inline-block;background:#75efb8;color:#241176;padding:12px 18px;border-radius:9px;text-decoration:none;font-weight:bold">Open hospitality dashboard</a></p>'
      : "",
    '<p style="font-size:12px;color:#716c8e;margin-bottom:0">Please review the request and prepare the quote.</p>',
    '</div>',
    '</div>'
  ].join("");
}
