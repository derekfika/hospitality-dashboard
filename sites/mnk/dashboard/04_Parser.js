// =============================================================================
// PARSER - hospitality booking XLSX to booking object
// =============================================================================
...
//   • "20:30" etc. (18-23 range)       (legacy 12-hr data stored as 24-hr)
...
/**
 * Parses any time representation found in hospitality booking forms and
 ...
 *  - Legacy quirk: values 18-23 are almost always 06-11 entered in 24-hr
...
/**
 * Hospitality form sanity check: the booking form is nominally 12-hr but values
...
/**
 * Parses any date representation found in hospitality booking forms and
...
function parseAngelCourtBookingSheet_(sheet) {
  ...
  booking.location = getConfiguredValue_("DEFAULT_LOCATION", CONFIG.DEFAULT_LOCATION || "");
